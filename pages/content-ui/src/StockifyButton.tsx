...
export default function StockifyButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <Button
      onClick={onClick}
      theme="custom"
      className="relative mx-3 px-6 py-3 font-bold text-yellow-400 bg-red-600 rounded-full shadow-md border-2 border-yellow-400 
      transition-all duration-300 hover:bg-red-700 hover:shadow-lg hover:border-yellow-300 focus:outline-none active:bg-red-800">
      Stockify!
    </Button>
  );
}
